...
shallow do
  namespace :v1 do
    ...
    resources :teams, extending do
      ...
      # Locations routes - nested under teams
      resources :locations, concerns: [:sortable] do
        collection do
          # Add near endpoint for geospatial queries
          get :near
        end
      end
    ...
    # Locations direct access with additional endpoints
    resources :locations, only: %i[show update destroy] do
      member do
        # Add children endpoint for hierarchical queries
        get :children
      end
    end
