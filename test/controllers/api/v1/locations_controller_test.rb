...
class Api::V1::LocationsControllerTest < Api::Test
  ...
  def assert_proper_object_serialization(location_data)
    ...
    assert_equal_or_nil location_data['location_type'], location.location_type
    assert_equal_or_nil location_data['parent_id'], location.parent_id
  ...
  test "update" do
    ...
    put "/api/v1/locations/#{@location.id}", params: {
      ...
      location: {
        ...
        location_type: 'Alternative String Value',
    ...
    assert_equal @location.location_type, 'Alternative String Value'
