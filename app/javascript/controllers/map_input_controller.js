 ...
 * 
 * Usage:
 * <div data-controller="map-input" 
 *      data-map-input-api-key-value="YOUR_MAPBOX_API_KEY"
 *      data-map-input-initial-value='{"type":"Point","coordinates":[-122.4194,37.7749]}'>
 *   <div data-map-input-target="map" style="height: 400px;"></div>
 *   <input type="hidden" name="location[geometry]" data-map-input-target="input">
 *   <div data-map-input-target="coordinates" class="text-sm text-gray-500 mt-1"></div>
 * </div>
 */
